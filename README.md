...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/md-environ-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14907&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/md-environ-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `md-environ` can be installed with:

```
conda install md-environ
```

It is possible to list all of the versions of `md-environ` available on your platform with:
